...
let currentTurn = "x"; //just realised no need to get the state of the board, we know the starting state of the board and we control the changes soooo yeah, duh.
